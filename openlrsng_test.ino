...
#define  nIRQ_1 (PIND & 0x08)==0x08 //D8
#define  nIRQ_0 (PIND & 0x08)==0x00 //D8

#define  nSEL_on PORTD |= (1<<2) //D2
#define  nSEL_off PORTD &= 0xFB //D2

#define  SCK_on PORTD |= (1<<3) //D3
#define  SCK_off PORTD &= 0xF7 //D3

#define  SDI_on PORTD |= (1<<4) //D4
#define  SDI_off PORTD &= 0xEF //D4

#define  SDO_1 (PIND & 0x05) == 0x05 //D5
#define  SDO_0 (PIND & 0x05) == 0x00 //D5
